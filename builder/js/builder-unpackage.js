...
function background_color(e, t, a) {
    var n = t, o = n.css("background-color").toString();
...
function RightContextMenu(e) {
    ...
    t < e.clientX ? ($("#contextmenu > .dropdown-menu").removeClass("pull-left"), $("#contextmenu > .dropdown-menu").addClass("pull-right")) : ($("#contextmenu > .dropdown-menu").removeClass("pull-right"), $("#contextmenu > .dropdown-menu").addClass("pull-left")), 0 == sortBegin && (e.preventDefault(), $("#contextmenu").position(
        {
            my: "left+3 bottom-3", of: e, collision: "fit"
        }
...
function init_parallax(e) {
    "destroy" == e ? $.stellar("destroy") : ($(window).stellar(
        {
            horizontalScrolling: !1, verticalScrolling: !0, responsive: !0, hideDistantElements: !0
        }
    ), $.stellar("refresh"))
}
...
$.getJSON("builder/components/components.json", function (e) {
        ...
        var t = $(this).attr("data-url") + "  .omg_component", a = $(this).clone(), n = $(this).attr("data-componentname"), o = $(a).appendTo(".omg_page.active_page");
        $("html, body").animate(
            {
            ...
            , 300), $("#dummy").load(t, function () {
                o.remove();
                var e = $(this).children().attr("data-componentname", n).appendTo(".omg_page.active_page");
        ...
        e.preventDefault();
        var t = $(this).attr("data-url") + "  .omg_component", a = $(this).clone(), n = ($(this).attr("data-componentname"), $(a).prependTo(".omg_page.active_page"));
...
$("input[type=range]").on("change", function () {
    ...
    {
        polyfill: !1, onSlideEnd: function (e, t) {
        var a = t.toString();
        ...
        var e = $(this).val(), t = $(this).val().replace(/\+/g, " ");
        ...
        for (e.preventDefault(), $('#myTab a[href="#property"]').tab("show"), $('#myTab a[href="#property"]').show(), $("#current_edit").text(e.target.tagName), cur_text_element = $(e.target), $("#cur_font").text($(e.target).css("font-family").replace(", sans-serif", "")), $("#cur_font").css("font-family", $(e.target).css("font-family")), i = 0;
             i < txt_available_options.length;
             i++) {
...
$(document).on("click", "#property .color", function (e) {
    }
), $("#property .color").on("beforeShow.spectrum", function (e, t) {
...
var cur_slideshow = null, cur_slideshow_slide = null;
...
$(document).on("click", "#addpage", function (e) {
        ...
        e.preventDefault();
        var t = $(this).parent().parent().parent().children("a").attr("data-pagename"), a = prompt("enter the page name", t);
...
), toastr.options =
{
    ...
    , loadStyleSheet();
var customStyleArray = [], customStyle = "";
...
var project_menu = "pagelist.list", projects_pages = "pages.data";
$("#openproject").on("click", function (e) {
        $("#file").trigger("click")
    }
), $("#file").on("change", function (e) {
        for (var t, a = e.target.files, n = 0;
             t = a[n];
             n++) {
